...
/**
 * Generated class for the EventoEditarPage page.
 *
...
export class EventoEditarPage {
  ...
  searchPacientes(event: {
    ...
    console.log(this.evento);
      this.clinicboxEventos.updateEvento(this.id, this.evento).then((result) => {
        console.log(result);
        let id = this.id;
    ...
    ionViewDidLoad() {
      console.log('ionViewDidLoad EventoDetallesPage');
    }
